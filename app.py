...
app.config['SECRET_KEY'] = env.config['SECRET_KEY']
bootstrap = Bootstrap(app)
# Create in-memory database
app.config['DATABASE_FILE'] = env.config['DATABASE_FILE']
...
# Create admin
admin = Admin.Admin(app, name='Sarthak Foundation Admin Portal', template_mode='bootstrap3')
